...
def send_request(fName, lName, sport):
    ...
    try:
        response = requests.get(
            url="https://api.mysportsfeeds.com/v1.1/pull/"+sport+"/2016-2017-regular/cumulative_player_stats.json?playerstats=G,A,Pts,Sh",
            params={
                    "player":playerName
                    },
        ...
        try:
            ...
            print('Decoding JSON has failed, wrong sport maybe?')
